...
public class VentanaVenta extends JFrame {
    ...
    List<TLineaVenta> lineasVenta; // Lista de líneas de venta para la venta actual
    ...
    private void initComponents() {
        ...
        panelBusqueda.add(new JLabel("C�digo Venta:"));
    ...
    private void agregarProducto() {
        ...
        // Suponiendo que tienes una lista de líneas de venta para la venta actual
        // Si no existe, deberías declararla como atributo de la clase VentanaVenta
        if (producto != null) {
    ...
    private void mostrarDetalleVenta(TVenta venta) {
        ...
        sb.append("C�digo: ").append(venta.getCodigo()).append("\n");
    ...
    private class VentaTableModel extends AbstractTableModel {
        ...
        private String[] columnNames = {"C�digo", "Fecha", "Cliente", "Total", "Facturada"};
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                ...
                case 4: return venta.getFactura() != null ? "S�" : "No";
                default: return null;
            }
        }
